...
<p className=' font-normal text-base md:text-lg text-neutral-300 max-w-[49rem] mx-auto lg:flex justify-center items-center relative right-[3rem]  lg:right-[23rem] lg:top-[-4rem]  top-[4rem] flex  '>we aim at improving the situation for Animals in long term i.e by providing veterniary care.
